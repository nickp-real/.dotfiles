...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "flutter-riverpod-snippets", "cmp-path", "cmp_luasnip", "nvim-autopairs", "cmp-rg" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textsubjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-autopairs", "vim-matchup", "nvim-ts-autotag", "hlargs.nvim", "tabout.nvim" },
  ...
  ["surround.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/surround.nvim",
...
vim.cmd [[au FileType flutter ++once lua require("packer.load")({'pubspec-assist.nvim', 'flutter-riverpod-snippets', 'flutter-tools.nvim'}, { ft = "flutter" }, _G.packer_plugins)]]
vim.cmd [[au FileType dart ++once lua require("packer.load")({'pubspec-assist.nvim', 'flutter-riverpod-snippets', 'flutter-tools.nvim'}, { ft = "dart" }, _G.packer_plugins)]]
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'LuaSnip', 'nvim-colorizer.lua', 'vim-illuminate', 'vim-fugitive', 'telescope.nvim', 'trouble.nvim', 'toggleterm.nvim', 'nvim-tree.lua', 'symbols-outline.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
vim.cmd [[au CmdLineEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "CmdLineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'neovim-session-manager', 'lualine.nvim', 'neoscroll.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'surround.nvim', 'presence.nvim', 'nvim-treesitter', 'Comment.nvim', 'null-ls.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'flutter-tools.nvim', 'vim-log-highlighting', 'hlargs.nvim', 'nvim-lspconfig', 'todo-comments.nvim', 'targets.vim', 'tabout.nvim', 'hop.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
