...
local no_errors, error_msg = pcall(function()
  ...
  _G.packer_plugins = {
    ["Comment.nvim"] = {
      after_files = {
        "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua",
      },
    ...
    ["cmp-buffer"] = {
      after_files = {
        "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua",
      },
      load_after = {
        ["nvim-cmp"] = true,
      },
    ...
    ["cmp-cmdline"] = {
      after_files = {
        "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/cmp-cmdline/after/plugin/cmp_cmdline.lua",
      },
      load_after = {
        ["nvim-cmp"] = true,
      },
    ...
    ["cmp-nvim-lsp-signature-help"] = {
      after_files = {
        "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp-signature-help/after/plugin/cmp_nvim_lsp_signature_help.lua",
      },
      load_after = {
        ["nvim-cmp"] = true,
      },
    ...
    ["cmp-nvim-lua"] = {
      after_files = {
        "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua",
      },
      load_after = {
        ["nvim-cmp"] = true,
      },
    ...
    cmp_luasnip = {
      after_files = {
        "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua",
      },
      load_after = {
        ["nvim-cmp"] = true,
      },
    ...
    ["flutter-tools.nvim"] = {
      config = {
        "\27LJ\2\nB\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\1K\0\1\0\16lsp.flutter\15lsp.config\frequire\0",
      },
      loaded = false,
      needs_bufread = true,
      only_cond = false,
    ...
    ["null-ls.nvim"] = {
      config = {
        "\27LJ\2\nB\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\1K\0\1\0\16lsp.null-ls\15lsp.config\frequire\0",
      },
      loaded = false,
      needs_bufread = false,
      only_cond = false,
    ...
    ["targets.vim"] = {
      ...
      needs_bufread = false,
      only_cond = false,
      path = "/home/nickp_real/.local/share/nvim/site/pack/packer/opt/targets.vim",
    ...
    ["telescope.nvim"] = {
      after = { "telescope-media-files.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim" },
  ...
  vim.cmd(
    [[au FileType javascript ++once lua require("packer.load")({'bracey.vim'}, { ft = "javascript" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au FileType log ++once lua require("packer.load")({'vim-log-highlighting'}, { ft = "log" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au FileType flutter ++once lua require("packer.load")({'pubspec-assist.nvim', 'flutter-tools.nvim', 'flutter-riverpod-snippets'}, { ft = "flutter" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au FileType dart ++once lua require("packer.load")({'pubspec-assist.nvim', 'flutter-tools.nvim', 'flutter-riverpod-snippets'}, { ft = "dart" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au FileType yaml ++once lua require("packer.load")({'pubspec-assist.nvim'}, { ft = "yaml" }, _G.packer_plugins)]]
  )
  ...
  vim.cmd(
    [[au CmdLineEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "CmdLineEnter *" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au BufEnter * ++once lua require("packer.load")({'lualine.nvim', 'neovim-session-manager', 'neoscroll.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'todo-comments.nvim', 'targets.vim', 'tabout.nvim', 'indent-blankline.nvim', 'presence.nvim', 'hop.nvim', 'gitsigns.nvim', 'flutter-tools.nvim', 'hlargs.nvim', 'nvim-lspconfig', 'null-ls.nvim', 'Comment.nvim', 'vim-log-highlighting', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
  )
  vim.cmd(
    [[au CursorHold * ++once lua require("packer.load")({'vim-fugitive', 'LuaSnip', 'toggleterm.nvim', 'symbols-outline.nvim', 'nvim-tree.lua', 'nvim-colorizer.lua', 'trouble.nvim', 'telescope.nvim', 'vim-repeat', 'vim-illuminate'}, { event = "CursorHold *" }, _G.packer_plugins)]]
  )
  time([[Defining lazy-load event autocommands]], false)
  vim.cmd("augroup END")
  vim.cmd([[augroup filetypedetect]])
  time(
    [[Sourcing ftdetect script at: /home/nickp_real/.local/share/nvim/site/pack/packer/opt/vim-log-highlighting/ftdetect/log.vim]],
    true
  )
