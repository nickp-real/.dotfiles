...
local no_errors, error_msg = pcall(function()
	...
	_G.packer_plugins = {
		...
		["vim-matchup"] = {
			...
			config = {
				"\27LJ\2\nW\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\2\vborder\3\1\vmethod\npopup!matchup_matchparen_offscreen\6g\bvim\0",
			},
			load_after = {
				["nvim-treesitter"] = true,
			},
	...
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'flutter-tools.nvim', 'targets.vim', 'surround.nvim', 'presence.nvim', 'Comment.nvim', 'nvim-lspconfig', 'nvim-treesitter', 'null-ls.nvim', 'tabout.nvim', 'indent-blankline.nvim', 'hop.nvim', 'todo-comments.nvim', 'vim-log-highlighting', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au CmdLineEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "CmdLineEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au CursorHold * ++once lua require("packer.load")({'symbols-outline.nvim', 'telescope.nvim', 'nvim-tree.lua', 'LuaSnip', 'nvim-colorizer.lua', 'vim-fugitive', 'trouble.nvim', 'toggleterm.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]])
