...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "cmp-path", "flutter-riverpod-snippets", "cmp-buffer", "cmp-rg", "cmp-cmdline", "nvim-autopairs", "cmp-nvim-lsp-signature-help" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-ts-rainbow", "vim-matchup", "nvim-treesitter-textsubjects", "tabout.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-autopairs", "hlargs.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'null-ls.nvim', 'indent-blankline.nvim', 'hop.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'targets.vim', 'tabout.nvim', 'Comment.nvim', 'presence.nvim', 'surround.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CmdLineEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "CmdLineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'neovim-session-manager', 'neoscroll.nvim', 'vim-log-highlighting', 'nvim-treesitter', 'flutter-tools.nvim', 'lualine.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'telescope.nvim', 'vim-fugitive', 'trouble.nvim', 'toggleterm.nvim', 'LuaSnip', 'symbols-outline.nvim', 'nvim-tree.lua', 'nvim-colorizer.lua'}, { event = "CursorHold *" }, _G.packer_plugins)]]
