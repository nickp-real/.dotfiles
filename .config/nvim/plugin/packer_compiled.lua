...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-nvim-lua", "cmp-fish", "cmp-cmdline", "flutter-riverpod-snippets", "tabout.nvim", "cmp_luasnip", "nvim-autopairs" },
  ...
  ["nvim-treesitter"] = {
    after = { "spellsitter.nvim", "nvim-ufo", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "vim-matchup", "nvim-ts-autotag", "hlargs.nvim", "Comment.nvim", "nvim-autopairs", "nvim-treesitter-textsubjects", "nvim-treesitter-textobjects" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'null-ls.nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'neoscroll.nvim', 'dial.nvim', 'mkdir.nvim', 'indent-blankline.nvim', 'hop.nvim', 'todo-comments.nvim', 'vim-log-highlighting', 'presence.nvim', 'nvim-treesitter', 'flutter-tools.nvim', 'hlargs.nvim', 'Comment.nvim', 'gitsigns.nvim', 'nvim-notify', 'bufdelete.nvim', 'bufresize.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'telescope.nvim', 'nvim-hlslens', 'toggleterm.nvim', 'glow.nvim', 'diffview.nvim', 'bracey.vim', 'neogit', 'LuaSnip', 'markdown-preview.nvim', 'vim-fetch', 'vim-asterisk', 'nvim-tree.lua', 'nvim-surround', 'symbols-outline.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
